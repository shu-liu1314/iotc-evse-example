...
#if(SE05X_NX_CRYPTO_AUTHENTICATE == 1 )
		SE05X_NX_DEBUG_PRINTF("_nx_crypto_ecdsa_verify() SE05x");

		extended_output = (NX_CRYPTO_EXTENDED_OUTPUT *)output;
		UINT signatureLen = 256;
		status = _nx_crypto_ecdsa_sign_se05x_wrapper(input,
...
#if (SE05X_NX_CRYPTO_AUTHENTICATE == 0)
    	SE05X_NX_DEBUG_PRINTF("_nx_crypto_ecdsa_verify() Software");
