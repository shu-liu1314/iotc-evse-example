...
#if(SE05X_NX_RANDOM == 1 )
    	SE05X_NX_DEBUG_PRINTF("_nx_secure_tls_send_clienthello()");
    	se05x_randomBytes((UCHAR *)&tls_session -> nx_secure_tls_key_material.nx_secure_tls_client_random[4],28);
#else
